...
//     //     if(productId){
//     //         navigate(`/seller/${myUser.uid}/updateProduct/${product._id}` , {state:product})
//     //     }
//     // }
...
//                                 {/* <Card.Img className="product_image" variant="top" src={image} /> */}
//                                 <Card.Img className="product_image" variant="top" src={product.image} alt={product.title}/>
...
//                                         <Button className="edit-btn" variant="primary" onClick={()=>updateProduct(product)}>Edit</Button>
//                                         <Button className="delete-btn" variant="danger" onClick={()=>deleteProduct(product)}>Delete</Button>
//                                     </div>
